...
class RsConsoleCompletionTest : RsConsoleCompletionTestBase() {
    ...
    @MockEdition(Edition.EDITION_2018)
    fun `test redefine import`() = checkContainsCompletion("""
        mod mod1 { pub struct Foo { pub field0: i32, pub field1: i32 } }
        mod mod2 { pub struct Foo { pub field0: i32, pub field2: i32 } }
    """, """
        use mod1::Foo;
    """, """
        let foo = Foo { field0: 0, field1: 0 };
    """, """
        use mod2::Foo;
    """, """
        foo./*caret*/
